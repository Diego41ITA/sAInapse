...
def create_envelope():
    ...
    d,c = signal.butter(6, 10/nyquist, btype="lowpass")
    steps_EMG_1muscle_1step_filtered_envelope = signal.lfilter(d, c, np.abs(steps_EMG_1muscle_1step_filtered))

    plt.figure(figsize=(12,4))
    plt.plot(steps_EMG_1muscle_1step_filtered_envelope[:1000, 0], label="Channel 0")
    plt.title("First 1000 Samples of enveloped EMG Channel 0")
    ...
    output_path = "/app/cat/data/plots/enveloped_data.html"
